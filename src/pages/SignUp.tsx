  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-teal-50 to-blue-100 dark:from-gray-900 dark:to-gray-950">
      <div className="w-full max-w-md p-6 bg-white/80 dark:bg-gray-800/70 backdrop-blur rounded-2xl shadow-lg">
        <h2 className="text-2xl font-bold text-teal-700 dark:text-teal-300 mb-1">Create an Account</h2>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">Start tracking your mood and journaling today 🌸</p>
        ...
        <p className="mt-4 text-sm text-center text-gray-600 dark:text-gray-400">
          ...
          <Link to="/signin" className="text-teal-600 hover:underline dark:text-teal-400">
            Sign in
          </Link>
        </p>
      </div>
